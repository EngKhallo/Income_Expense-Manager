...
if (isset($_POST) && !empty($_POST)) :
    ...
    $sql = "INSERT INTO expense_category(expense_type) VALUES ('$type')";
    $result = mysqli_query($conn, $sql);

    if (!$result) die("Database Insertion failed" . mysqli_error($conn));
    if ($result) header("Location: expense_category.php");
endif;
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="expense_category.php" method="POST">
                                <div class="form-group">
                                    <label for="title">Expense Type:</label>
                                    <input type="text" name="type" class="form-control input-default mb-4" placeholder="Enter Expense Type">
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <button type="button" class="btn btn-primary text-white ml-4 mb-4 py-2" data-bs-toggle="modal" data-bs-target="#accountsModal">
                                ...
                                <h3 class="text-success ml-4">Expense Transactions Detailed</h3>
