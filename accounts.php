...
if (isset($_POST) && !empty($_POST)) :
    ...
    $sql = "INSERT INTO accounts(account_name) VALUES ('$name')";
    $result = mysqli_query($conn, $sql);

    if (!$result) die("Database Insertion failed" . mysqli_error($conn));
    if ($result) header("Location: accounts.php");
endif;
                        ...
                        <div class="modal-body">
                            <form action="accounts.php" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control input-default mb-4" placeholder="Enter Account Type">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-primary ml-4 mb-4 py-2" data-bs-toggle="modal" data-bs-target="#accountsModal">
                                    <i class="fa fa-plus"></i>
                                </button>
                                <h3 class="text-success ml-4">List of Accounts</h3>
