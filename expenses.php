...
$sql = "select expense_id, expense_category.expense_type, expense_name, Amount,accounts.account_name,expense_date,exp_description
    FROM expense
    INNER JOIN expense_category
    ON expense.exp_cat_id = expense_category.exp_cat_id
    INNER JOIN accounts
    ON accounts.account_id = expense_category.exp_cat_id";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-danger ml-4">Expense Transactions Detailed</h3>
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_object($result)) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" class="btn btn-success text-white h5 mb-2"> <i class="fa fa-edit"></i> </a>
                                                        <a href="" class="btn btn-danger text-white h5 mb-2"> <i class="fa fa-trash"></i> </a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
