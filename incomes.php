...
$sql = "select income_id, income_name, income_type, Amount, account_name, income_date, inc_description from income
    INNER JOIN accounts
    ON income.account_id = accounts.account_id
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-success ml-4">Income Transactions Detailed</h3>
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_object($result)) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-success text-white mb-2"> <i class="fa fa-edit"></i> </a>
                                                        <a href="#" class="btn btn-danger text-white mb-2"> <i class="fa fa-trash"></i> </a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
